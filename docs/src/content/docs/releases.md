...
Improves the desktop search toolbar by embedding the Traffic body-search scope, replacing the native clear control, exposing `Ctrl K`, and keeping the controls usable in narrow windows.
